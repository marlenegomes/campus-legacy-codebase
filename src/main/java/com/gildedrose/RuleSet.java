...
public class RuleSet {
    ...
    static final Rule increaseQualityByOneBackstage = new Rule(Range.atLeast(11) , quality -> quality + 1);
    ...
    static final Rule increaseQualityByOneWine = new Rule(Range.atLeast(300), quality -> quality + 1);
    static final Rule decreaseQualityByOneWine = new Rule(Range.lessThan(0), quality -> quality - 1);
    static final Rule maintainQualityWine = new Rule(Range.closedOpen(0, 300), quality -> quality);
