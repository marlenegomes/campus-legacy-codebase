...
class GildedRoseTest {
    ...
    @Test
    void redWineQualityShouldDecreasebyOne() {
        Item[] items = new Item[]{
                new Item("Red red wine", -299, 51),
        };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        assertThat(app.items[0].quality).isEqualTo(50);
    ...
    @Test
    void ItemSellinShouldDecreaseByOne() {
        Item[] items = new Item[]{
                new Item("Red red wine", 200, 40),
        };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        assertThat(app.items[0].sellIn).isEqualTo(199);
    }
